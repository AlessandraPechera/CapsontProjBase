        ...
        <header class="header-mobile d-block d-lg-none">
            ...
            <nav class="navbar-mobile">
                ...
                <ul class="navbar-mobile__list list-unstyled">
                 ...
                 <li>
                            <a href="questiocreateQuestionsnCreate.php">
                                <i class="fas fa-calendar-alt"></i>Add & Edit Questions</a>
                 </li>
                 <li>
                            <a href="logout.php">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Add Student</h3>
                                        </div>
                                        <hr>
                                        <form action="process2.php" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="stud_id" name="stud_id" type="text" class="form-control stud_id valid" data-val="true" data-val-required="Enter Student's Id number"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="fname" name="fname" type="text" class="form-control fname valid" data-val="true" data-val-required="Enter Student's first name"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="lname" name="lname" type="text" class="form-control lname valid" data-val="true" data-val-required="Enter Student's last name"
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="section" name="section" type="text" class="form-control section valid" data-val="true" data-val-required="Enter Student's Section "
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="email" name="email" type="email" class="form-control email valid" data-val="true" data-val-required="Enter Student's Email "
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="phn_n" name="phn_n" type="text" class="form-control phn_n valid" data-val="true" data-val-required="Enter Student's Phone number "
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="addrss" name="addrss" type="text" class="form-control addrss valid" data-val="true" data-val-required="Enter Student's Address "
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="gender" name="gender" type="text" class="form-control gender valid" data-val="true" data-val-required="Enter Student's Age "
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="date_b" name="date_b" type="date" class="form-control gender valid" data-val="true" data-val-required="Enter Student's Age "
                                                ...
                                                <div>
                                                 <input id="submit_button" type="submit" name= "add_students" class="btn btn-lg btn-info btn-block" value="Add Student">
                                                    &nbsp;
